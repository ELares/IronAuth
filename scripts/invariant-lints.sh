...
scan time-via-env 'SystemTime::now|Instant::now' 43
...
# 38 -> 43: the PKI method's chain-validation tests (issue #159) anchor their cert
# windows to the same real wall-clock the harness clock is advanced to.
