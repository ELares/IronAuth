...
## Run the local development emulator

Use the local development emulator with a deterministic seed for offline
application sign-in tests. The recipe below starts a seeded provider without
