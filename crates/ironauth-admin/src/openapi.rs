...
use crate::views::{
    ...
    CreateFlowVersionRequest, CreateInitialAccessTokenRequest, CreateInvitationRequest,
    CreateManagementKeyRequest, CreateMembershipRequest, CreateOrganizationRequest,
    CreateTenantRequest, CreateUserRequest, DcrPolicyList, DcrPolicyView, EnvironmentList,
    EnvironmentView, ExtendSignupQuarantineRequest, FlowVersionView, GuardrailView,
    ...
    LocaleBundleView, ManagementKeyCreated, ManagementKeyList, ManagementKeyView, MembershipList,
    MembershipView, OperatorList, OperatorView, OrganizationList, OrganizationView,
    RecoveryApprovalCaseView, RecoveryApprovalDecisionView, RecoveryApprovalList,
    RecoveryApprovalStateView, RefreshFamilyList, RefreshFamilyView, ReorderTokenHooksRequest,
    ResourceTypeView, ResourceTypesList, RevokeSessionsRequest, RollbackTokenHookRequest,
    SessionJwtModeView, SessionList, SessionRevocationView, SessionTokenTemplateView,
    SessionTokenTemplatesView, SessionView, SetBrandRequest, SetClaimsMappingRequest,
    SetClientAdminConsentRequest, SetLocaleRequest, SetSessionJwtModeRequest,
    SetSessionTokenTemplateRequest, SetSignupFormRequest, SetUserStateRequest, SignupFormFieldView,
    SignupFormView, SignupQuarantineCaseView, SignupQuarantineDecisionView, SignupQuarantineList,
    SignupQuarantineReasonView, SignupQuarantineStateView, TenantCreated, TenantList,
    TenantStatusView, TenantView, TestTokenHookRequest, TestTokenHookResponse,
...
#[openapi(
    ...
    paths(
        ...
        crate::org_contacts::create_org_contact,
        crate::org_contacts::list_org_contacts,
        crate::org_contacts::delete_org_contact,
        ...
        crate::scim_push_connections::set_scim_push_connection_active,
        crate::scim_push_connections::delete_scim_push_connection,
        crate::ldap_connectors::list_ldap_connectors,
        crate::ldap_connectors::list_ldap_connector_health,
        crate::ldap_connectors::create_ldap_connector,
        crate::ldap_connectors::set_ldap_connector_active,
        crate::ldap_connectors::delete_ldap_connector,
        ...
        crate::session_token_templates::set_session_token_template,
        crate::session_token_templates::list_session_token_templates,
        crate::session_token_templates::delete_session_token_template,
        crate::challenge_components::deploy_challenge_component,
        crate::challenge_components::list_challenge_components,
        crate::challenge_components::delete_challenge_component,
        crate::challenge_components::list_challenge_component_secrets,
        crate::challenge_components::grant_challenge_component_secret,
        crate::challenge_components::revoke_challenge_component_secret,
        ...
        crate::key_rotation::list_signing_key_rotation,
        crate::key_rotation::advance_signing_key_rotation,
        crate::key_rotation::break_glass_signing_key_rotation,
        crate::quota::list_quota_limits,
        crate::quota::set_quota_limit,
        crate::quota::clear_quota_limit,
        ...
        crate::external_issuers::list_external_issuers,
        crate::external_issuers::register_external_issuer,
        crate::external_issuers::set_external_issuer_enabled,
        crate::external_issuers::list_subject_mappings,
        crate::external_issuers::create_subject_mapping,
        crate::external_issuers::set_subject_mapping_enabled,
        crate::external_issuers::delete_external_issuer,
        crate::external_issuers::delete_subject_mapping,
    ...
    components(schemas(
        ...
        crate::scim_push_connections::ScimPushConnectionListView,
        crate::scim_push_connections::CreateScimPushConnectionRequest,
        crate::scim_push_connections::ScimPushConnectionCreated,
        crate::scim_push_connections::SetScimPushActiveRequest,
        crate::ldap_connectors::LdapConnectorView,
        crate::ldap_connectors::LdapConnectorListView,
        crate::ldap_connectors::LdapHealthView,
        crate::ldap_connectors::LdapHealthListView,
        crate::ldap_connectors::CreateLdapConnectorRequest,
        crate::ldap_connectors::LdapConnectorCreated,
        crate::ldap_connectors::SetLdapConnectorActiveRequest,
        crate::scim_connections::ScimConnectionListView,
        crate::scim_connections::ScimConnectionCreated,
        crate::scim_connections::CreateScimConnectionRequest,
        TenantView,
        TenantCreated,
        TenantList,
        TenantStatusView,
        ...
        crate::org_contacts::OrgContactView,
        crate::org_contacts::OrgContactList,
        crate::org_contacts::CreateOrgContactRequest,
        ...
        crate::quota::QuotaLimitView,
        crate::quota::QuotaLimitsView,
        crate::quota::SetQuotaLimitRequest,
