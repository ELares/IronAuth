...
fn documented_paths_are_the_expected_set() {
    ...
    assert_eq!(
        ...
        vec![
            ...
            "DELETE /v1/tenants/{tenant_id}/environments/{environment_id}/challenge-components",
            "DELETE /v1/tenants/{tenant_id}/environments/{environment_id}/challenge-components/secrets",
            "DELETE /v1/tenants/{tenant_id}/environments/{environment_id}/connectors/{connector_id}",
            "DELETE /v1/tenants/{tenant_id}/environments/{environment_id}/external-issuers/{issuer_id}",
            ...
            "DELETE /v1/tenants/{tenant_id}/environments/{environment_id}/organizations/{organization_id}/ldap-connectors/{connector_id}",
            ...
            "GET /v1/tenants/{tenant_id}/environments/{environment_id}/challenge-components/secrets",
            ...
            "GET /v1/tenants/{tenant_id}/environments/{environment_id}/external-issuers",
            "GET /v1/tenants/{tenant_id}/environments/{environment_id}/flow-targets",
            "GET /v1/tenants/{tenant_id}/environments/{environment_id}/flow-targets/{target_id}/dead-letters",
            ...
            "GET /v1/tenants/{tenant_id}/environments/{environment_id}/organizations/{organization_id}/ldap-connectors/health",
            ...
            "GET /v1/tenants/{tenant_id}/environments/{environment_id}/subject-mappings",
            ...
            "PATCH /v1/tenants/{tenant_id}/environments/{environment_id}/external-issuers/{issuer_id}",
            ...
            "PATCH /v1/tenants/{tenant_id}/environments/{environment_id}/subject-mappings/{mapping_id}",
            ...
            "POST /v1/tenants/{tenant_id}/environments/{environment_id}/external-issuers",
            "POST /v1/tenants/{tenant_id}/environments/{environment_id}/flow-targets",
            "POST /v1/tenants/{tenant_id}/environments/{environment_id}/flow-targets/{target_id}/replay",
            ...
            "POST /v1/tenants/{tenant_id}/environments/{environment_id}/organizations/{organization_id}/ldap-connectors",
            ...
            "POST /v1/tenants/{tenant_id}/environments/{environment_id}/subject-mappings",
