...
pub use repository::{
    ...
    RoutingRuleRepo, RoutingSelector, SESSION_ENDED_CONSUMER, SamlCertificate, SamlConnection,
    SamlConnectionRepo, SamlKeyKind, SamlReplayRepo, SamlSpKey, SamlSpKeyMaterial,
