...
pub use id::{
    ...
    AgentPrincipalId, AgentPrincipalKind, ScopedId, ScopedKind, ServiceAccountId,
    ServiceAccountKind, ServiceId, ServiceKind,
...
pub use repository::{
    ...
    ActingAgentRepo, AgentRecord, AgentRepo, NewAgent, ServiceAccountMembershipRecord,
    ServiceAccountRepo, SessionEndCause, SessionEndedEvent,
