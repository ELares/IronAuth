...
pub use repository::{
    ...
    CERTIFICATE_PIN_REQUEST_CONSUMER, CIBA_PING_CONSUMER, ClientAssertionJtiRepo,
    ClientAuthDiagnosticQuery, ClientAuthDiagnosticReason, ClientAuthDiagnosticRecord,
    ClientAuthDiagnosticsRepo, ClientAuthRecord, ClientBackchannelProfile, ClientCredentialsAccess,
    ClientRecord, ClientRepo, ClientResourcePolicy, ClientScopePolicy, ClientScopePolicyRepo,
    ClientSessionRepo, CodeBindings, CompletionOutcome, ConsentRepo, ConsentRevocation,
