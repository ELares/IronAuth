...
pub use repository::{
    ...
    OutboxMessage, OutboxRepo, PasswordRemovalOutcome, PendingInvitation, PermissionEntryKind,
    PermissionRecord, PermissionRepo, PolicyDecisionInputs, PolicyDecisionTraceQuery,
