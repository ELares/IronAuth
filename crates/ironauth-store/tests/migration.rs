...
#[tokio::test]
async fn production_chain_is_only_the_thirty_nine_real_migrations_and_ships_no_demo_object() {
    ...
    assert_eq!(
        ...
        39,
        "the production chain is exactly thirty-nine migrations (isolation, audit log, management \
