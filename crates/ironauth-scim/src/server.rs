...
use ironauth_store::{ScimConnection, Store};
use serde_json::json;
...
impl ScimState {
    ...
    #[must_use]
    pub fn new(store: Store, env: ironauth_env::Env, limits: ScimLimits) -> Self {
        Self {
            inner: Arc::new(ScimStateInner { store, env, limits }),
        }
    }
