...
use ironauth_scim::{parse_filter, parse_patch_path, parse_resource_path};
...
///
/// Pinned by NAME rather than by counting files, so adding a seventh fixture does not make
/// this pass while one of the six operations is quietly missing.
#[test]
